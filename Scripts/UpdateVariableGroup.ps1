...
.EXAMPLE
  UpdateVariableGroup.ps1 -variableGroupName dennyisgek -variableHashTable @{applicationName = @{value = 'Johntrallala'; isSecret= 'false'}; url = @{ value = 'TestUrl'; isSecret='true'}} -userName UserNameMagLeegZijn -vstsPat hbytg3majk2cyny7yxuhl3m5ns3zzzguhbwo4jtuulw5vup3vzlq -collectionName raboweb -projectName tas -variableGroupId 630
#>
[CmdletBinding()]
Param(
