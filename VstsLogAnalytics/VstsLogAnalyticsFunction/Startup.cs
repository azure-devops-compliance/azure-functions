...
namespace VstsLogAnalyticsFunction
{
    internal class Startup : IWebJobsStartup
    {
        ...
        private void RegisterServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IVstsRestClient>(new VstsRestClient("raboweb", vstsPat));
            ...
            var organisation = Environment.GetEnvironmentVariable("organisation", EnvironmentVariableTarget.Process) ?? "raboweb-test";
